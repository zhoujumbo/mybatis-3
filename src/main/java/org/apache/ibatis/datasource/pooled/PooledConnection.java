 ...
 *
 * 比较重要的方法 {@link #invoke(Object, Method, Object[])}
...
class PooledConnection implements InvocationHandler {
   ...
   *
   * proxyConnection 属性，代理的 Connection 连接，在 构造函数<1> 处，基于 JDK Proxy 创建 Connection 对象，并且 handler 对象就是 this ，
   * 也就是自己。那意味着什么？后续对 proxyConnection 的所有方法调用，都会委托给 PooledConnection#invoke(Object proxy, Method method, Object[] args) 方法。
   */
  ...
  public Object invoke(Object proxy, Method method, Object[] args) throws Throwable {
    ...
    // <1> 判断调用的方法是不是 Connection#close() 方法，
    // 如果是，则调用 PooledDataSource#pushConnection(PooledConnection conn) 方法，将该连接放回到连接池中，从而避免连接被关闭。
    ...
    try {
      ...
      if (!Object.class.equals(method.getDeclaringClass())) {
        ...
        // 判断， 当 valid 为 false 时，意味着连接无效，所以抛出 SQLException 异常
        checkConnection();
      }
